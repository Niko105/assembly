BITS 64
default rel
global itoaS ;exported, extern itoaS
...
;----------------------------------explanation----------------------------------
;itoaS, integer to ascii, takes an integer, a buffer, and an out-pointer
...
;this is the slow version! very outdated, uses div
;-------------------------------------------------------------------------------

;int itoaS(rdi=int, rsi=&buffer, rdx=&out_start). clobbers rax, rcx, r8, r10
itoaS:
